...
import { onUpdateLocation, UserState, AplicationState } from '../redux'
...
const _LandingScreen: React.FC<LandingProps> = (props) => {
	...
	useEffect(() => {
		...
		(async() => {
			...
			if(status !== 'granted'){
				setErrorMsg('Permissions to access location is not granted');
			}
			...
			if(coords){
				...
				//notify user something went wrong width location
			}
		})();
